...
function display( $feature = '' ) {
	if ( 'content-post-format' === $feature ) {
		...
		endwhile;
			the_post_navigation(
				array(
					'next_text' => '<span class="post-next" aria-hiddent="true">' . esc_html__( 'Next', 'ecclesiastical' ) . '</span><span class="post-title">%title</span>',
					'prev_text' => '<span class="post-previous" aria-hidden="true">' . esc_html__( 'Previous', 'ecclesiastical' ) . '</span><span class="post-title">%title</span>',
				)
			);
		comments_template();
		...
		the_posts_navigation(
			array(
				'prev_text' => '<span class="post-previous" aria-hidden="true">' . esc_html__( 'Older', 'ecclesiastical' ) . '</span><span class="post-title">Projects</span>',
				'next_text' => '<span class="post-next" aria-hiddent="true">' . esc_html__( 'Newer', 'ecclesiastical' ) . '</span><span class="post-title">Projects</span>',
			)
		);
		comments_template();
